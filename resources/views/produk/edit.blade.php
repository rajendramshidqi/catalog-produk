            ...
            <div class="col-lg-12">
                ...
                <form action="{{ route('produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="id_merek" name="id_merek"
                            ...
                            @foreach ($merek as $data)
                                <option value="{{ $data->id }}" {{ old('id_merek', $produk->id_merek) == $data->id ? 'selected' : '' }}>
                                    {{ $data->nama_merek }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="id_kategori" name="id_kategori"
                            ...
                            @foreach ($kategori as $data)
                                <option value="{{ $data->id }}" {{ old('id_kategori', $produk->id_kategori) == $data->id ? 'selected' : '' }}>
                                    {{ $data->kategori }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        @if ($produk->foto)
                            <div class="mb-2">
                                <img src="{{ asset('storage/produk/' . $produk->foto) }}" alt="Foto Produk"
