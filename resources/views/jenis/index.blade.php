                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               <a href="{{route('jenis.create')}}" class="btn btn-sm btn-primary" style="float:right">Tambah</a>
                   ...
                   <table class="table">
                    ...
                    <tbody>
                        ...
                        <form action="{{route('jenis.destroy',$data->id)}}" method="POST">
                            @csrf                        
                            @method('DELETE')
                    <a href="{{route('jenis.edit', $data->id)}}" class="btn btn-success">edit</a>
                    <a href="{{route('jenis.show', $data->id)}}" class="btn btn-warning">show</a>
